...
#Taller por: Denisse Fierro Arcos (R-Ladies Galapagos) - María Isabel Arrieta Escobar (R-Ladies Barranquilla)
...
#----Ejercicio 1. Comando básicos----

#----Creamos la tabla del ejemplo con la función tribble----
...
#----Ordenar datos I----
desordenado%>% 
  gather() #Empleamos la función gather () sin argumentos

#----Ordenar datos II----
desordenado%>% 
  gather(key,value, #Los dos primeros argumentos son los nombres de las columnas que se crerán.
         '2018','2019')  #Los siguientes las columnas que pasaremos a filas. Estos nombres de columna se repetirán en key y las filas llenarán value.  
...
#----Filtrado para datos númericos. filter()----
...
#----Ejercicio 2. Empleo de los comando básicos empleando una base de datos más compleja----
